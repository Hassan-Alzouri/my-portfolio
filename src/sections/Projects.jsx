                ...
                <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                    {currentProject.spotlight && (
                        <div className="absolute top-0 right-0">
                            ...
                            <img src={getAssetPath(currentProject.spotlight)} alt="spotlight" className="w-full h-96 object-cover rounded-xl" />
                        </div>
                    )}
                    {/* Updated with getAssetPath */}
                    <div className="p-2 backdrop-filter backdrop-blur-3xl w-fit rounded-lg bg-white flex items-center justify-center" style={currentProject.logoStyle}>
                        <img src={getAssetPath(currentProject.logo)} alt="logo" className="w-10 h-10 object-contain rounded" />
                    </div>
